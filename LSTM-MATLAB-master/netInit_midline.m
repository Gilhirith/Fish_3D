function [in_size, gate_size, out_size, share_size,share_size2,numMmcell, in, ingate, cellstate,cells,outgate,...
    node_outgateInit,cellinInit,node_cellbiasInit,delta_outInit,cellstatusInit] = netInit_midline(problem)

    global mones mzeros W_midline W_motion
