function Data_Association_with_Predict_Combine_2D()
...
%             end
        ...
        XR = Translate_to_Right_View(trajs_3d{obj_mi}.traj{fr - trajs_3d{obj_mi}.bg_frame + 1}.head_pt, F_matrix{1}.om, F_matrix{1}.T);
        trajs_3d{obj_mi}.traj{fr - trajs{obj_mi}.bg_frame + 1}.view{2}.head_pt_2d = Reproject_to_2D(XR, Cam_Para{2}.kc, Cam_Para{2}.fc, Cam_Para{2}.cc, Cam_Para{2}.alpha_c);
        XR2 = Translate_to_Right_View(trajs_3d{obj_mi}.traj{fr - trajs_3d{obj_mi}.bg_frame + 1}.head_pt, F_matrix{2}.om, F_matrix{2}.T);
        trajs_3d{obj_mi}.traj{fr - trajs{obj_mi}.bg_frame + 1}.view{3}.head_pt_2d = Reproject_to_2D(XR2, Cam_Para{3}.kc, Cam_Para{3}.fc, Cam_Para{3}.cc, Cam_Para{3}.alpha_c);
